...
### 1.1 Taxa de Conclusao da Sprint
...
| **Forma de Cálculo** | *Taxa de Resolução* = ( *Número de defeitos corrigidos* / *Número de defeitos reportados* ) x 100 |
| **Escala de Unidade** | Porcentagem (%) |
...
| **Forma de Cálculo** | *Cobertura* = ( *Linhas de código executadas pelos testes* / *Total de linhas de código do sistema* ) x 100 |
| **Escala de Unidade** | Porcentagem (%) |
...
| :---: | :---: | :---: | :---: |
| **Sprint 3** | 64.00% | 100.00% | N/A |
| **Sprint 4** | 91.67% | 100.00% | 80.50% (com 32 testes) |
