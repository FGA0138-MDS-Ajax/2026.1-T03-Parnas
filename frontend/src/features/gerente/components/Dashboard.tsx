    ...
    <div>
      ...
      <section className="kpi-grid">
        <div className="kpi-card kpi-abertos">
          <span className="kpi-header">Aguardando Triagem</span>
          <span className="kpi-value">{loading ? '...' : stats.abertos}</span>
        ...
        <div className="kpi-card kpi-atribuidos">
          <span className="kpi-header">Delegados / Atribuídos</span>
          <span className="kpi-value">{loading ? '...' : stats.atribuidos}</span>
          <div className="kpi-icon">
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="kpi-card kpi-em-andamento">
          <span className="kpi-header">Manutenções em Curso</span>
          <span className="kpi-value">{loading ? '...' : stats.emAndamento}</span>
          <div className="kpi-icon">
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="kpi-card kpi-tecnicos">
          <span className="kpi-header">Equipe Técnica Ativa</span>
          <span className="kpi-value">{loading ? '...' : stats.totalTecnicos}</span>
          <div className="kpi-icon">
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
