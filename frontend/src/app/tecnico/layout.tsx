...
export default function TecnicoLayout({
  ...
  const isActive = (path: string) => {
    return pathname === path || (path === '/tecnico/chamado' && pathname.startsWith('/tecnico/chamado/')) ? 'active' : '';
  };
        ...
        <nav style={{ flex: 1 }}>
          <ul className="sidebar-menu">
            <li className="menu-li-dashboard">
              <Link href="/tecnico/fila" className={`menu-item-link ${isActive('/tecnico/fila')}`}>
            ...
            <li className="menu-li-nova">
              <Link href="/tecnico/chamado" className={`menu-item-link ${isActive('/tecnico/chamado')}`}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
